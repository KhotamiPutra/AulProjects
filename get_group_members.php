...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['username'])) {
        ...
        $sql = "SELECT users.username FROM group_members JOIN users ON group_members.user_id = users.user_id WHERE group_members.group_id = (SELECT group_id FROM groups WHERE group_name = '$selectedGroup')";
